                        ...
                        <svg viewBox="0 0 190 190">
                            ...
                            <g id="submit">
                                <g id="Ellipse_2">
                                    <path className="st10"
                                          style={{fill:'#0072d3'}}
                                          d="M6 95C6 43.5 43.5 5.9 95 5.9V0C42.5 0 0 42.5 0 95s42.5 95 95 95v-5.9c-51.5 0-89-37.6-89-89.1z"/>
                                    ...
                                    <path className="st11"
                                          ...
                                          d="M95 0v5.9c51.5 0 89 37.7 89 89.1 0 51.5-37.6 89.1-89 89.1v5.9c52.5 0 95-42.5 95-95S147.5 0 95 0"/>
                                </g>
